...
* 2025年5月16日:link:https://community.netapp.com/t5/Tech-ONTAP-Blogs/Automating-registry-failover-for-disaster-recovery-with-Trident-protect-post/ba-p/460777["Trident Protect の復元後フックを使用して災害復旧のためのレジストリ フェイルオーバーを自動化する"^]
...
* 2025年5月13日:link:https://community.netapp.com/t5/Tech-ONTAP-Blogs/Storage-class-migration-with-Trident-protect-backup-amp-restore/ba-p/460637["Trident Protect バックアップ  復元によるストレージ クラスの移行"^]
