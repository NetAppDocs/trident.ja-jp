...
通常は、最初のインストールと同じ方法でアップグレードする必要がありますが、link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["インストール方法を切り替えます"]。Trident をアップグレードするには 2 つのオプションがあります。
