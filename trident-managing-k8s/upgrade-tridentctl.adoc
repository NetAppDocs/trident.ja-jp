...
.作業を開始する前に
link:upgrade-trident.html#step-3-select-an-upgrade-method["アップグレード方法を選択します"]を使用してアップグレードする前に `tridentctl`を確認してください。
...
----
. Trident を再インストールします。link:../trident-install/kubernetes-deploy-tridentctl.html["tridentctlを使用したTridentのインストール"]を参照してください。
