...
* 少なくとも1つのVolumeSnapshotClassが存在することを確認してください。詳細については、link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["ボリュームSnapshotクラス"]を参照してください。
...
----
====
Trident Protect を使用してアプリケーションを定義し、VM をリストアする方法については、link:trident-protect-kubevirt-vms.html["KubeVirt 仮想マシンを Trident Protect で保護する"]を参照してください。
