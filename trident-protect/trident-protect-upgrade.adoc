...
* 4リリース期間外のリリースからアップグレードする場合は、複数段階のアップグレードを実行します。link:../earlier-versions.html["以前のバージョン"]からアップグレードする場合は、そのバージョンのアップグレード手順を使用して、4リリース期間に収まる最新のリリースにアップグレードします。たとえば、24.10を実行していて26.02にアップグレードする場合（
+
