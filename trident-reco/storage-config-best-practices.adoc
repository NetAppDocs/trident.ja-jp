...
NetApp Tridentは、 `ontap-nas` 、 `ontap-san` 、 そして `solidfire-san`ストレージ ドライバー。使用する際は `ontap-nas-flexgroup`または `ontap-nas-economy`ドライバーの場合、クローン作成はサポートされません。既存のボリュームから新しいボリュームを作成すると、新しいスナップショットが作成されます。
...
ブロック サイズと帯域幅は IOPS の数に直接影響します。ブロック サイズが大きくなるにつれて、システムはより大きなブロック サイズを処理するために必要なレベルまで帯域幅を増加させます。帯域幅が増加すると、システムが達成できる IOPS の数は減少します。QoS とパフォーマンスの詳細については、 https://www.netapp.com/pdf.html?item=/media/10502-tr-4644.pdf["SolidFire のサービス品質"^]を参照してください。
...
* https://www.netapp.com/pdf.html?item=/media/10507-tr4639.pdf["SolidFire for Linux を設定しています"^]
...
* https://www.netapp.com/pdf.html?item=/media/10513-tr-4635.pdf["NetApp SolidFire および Cassandra"^]
* https://www.netapp.com/pdf.html?item=/media/10511-tr4606.pdf["SolidFire での Oracle のベストプラクティス"^]
* https://www.netapp.com/pdf.html?item=/media/10512-tr-4610.pdf["SolidFire での PostgreSQL のベストプラクティスです"^]
