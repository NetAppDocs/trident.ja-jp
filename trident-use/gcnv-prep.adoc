...
Google Cloud NetApp Volumes を初めて使用する場合、または新しい場所で使用する場合は、Google Cloud NetApp Volumes をセットアップして NFS または SMB ボリュームを作成するために、初期設定が必要です。link:https://cloud.google.com/netapp/volumes/docs/before-you-begin/application-resilience["作業を開始する前に"^]を参照してください。
