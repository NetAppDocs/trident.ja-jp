...
+
image::../media/aws-eks-01.png[EKS クラスタの Add-ons タブ]

. [AWS Marketplace add-ons]*にアクセスし、_storage_categoryを選択します。
+
image::../media/aws-eks-02.png[AWS Marketplace アドオンストレージカテゴリ]

. NetApp Trident *を探し、Tridentアドオンのチェックボックスを選択して* Next *をクリックします。
. 必要なアドオンのバージョンを選択します。
+
image::../media/aws-eks-03.png[Tridentアドオンバージョンの選択]

. 必要なアドオン設定を構成します。
+
image::../media/aws-eks-04.png[Tridentアドオン設定]
...
+
image::../media/aws-eks-05.png[Tridentアドオンのアクティブステータス]
...
----
. セットアップを続行し、ストレージ バックエンドを構成します。詳細については、link:trident-fsx-storage-backend.html["ストレージバックエンドの設定"]を参照してください。
